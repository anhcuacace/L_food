...
import com.tunanh.lfood.ativity.activity.IntroActivity

class IntroViewPagerAdapter(private var title: List<String>,private var description: List<String>,private var img: List<Int>,private var color: List<Int>): RecyclerView.Adapter<IntroViewPagerAdapter.Pager2ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Pager2ViewHolder {
        return Pager2ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.layout_screen,parent,false))
    }
